 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |   Z  |   X  |   C  |   V  |   B  |    Enter    |   N  |   M  | Left | Ctrl | Right|
 * `-----------------------------------------------------------------------------------'
 */
[_QWERTY] = LAYOUT_planck_mit(
     ...
     KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,       KC_ENT,        KC_N,    KC_M, KC_LEFT, KC_RCTL, KC_RGHT
),
...
[_FN] = LAYOUT_planck_mit(
  ...
  _______, _______, RGB_HUI, RGB_HUD, _______,       KC_SPC,     _______, _______, KC_COMM, _______,  KC_DOT
)
};
