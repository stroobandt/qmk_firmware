...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_FN] = LAYOUT_68_ansi(
    ...
    _______, KC_UNDO, KC_CUT,  KC_COPY, KC_PSTE, KC_MPRV, KC_MNXT, KC_MUTE, KC_VOLD, KC_VOLU, KC_FIND,                   KC_MPLY,          KC_MS_U,
    KC_WAKE, KC_APP,  _______,                            KC_MPLY,                            _______, _______, _______,          KC_MS_L, KC_MS_D, KC_MS_R
  )
};
